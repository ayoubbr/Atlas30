        ...
        <div class="forum-layout">
            <div class="forum-main">
                ...
                <div class="forum-header">
                    <h2 class="forum-title">All Discussion Groups</h2>
                    <div class="forum-actions">
                        @auth
                            <a href="{{ route('forum.create-group') }}" class="btn btn-primary btn-icon">
                ...
                <div class="thread-list" id="thread-list">
                    ...
                    @foreach ($groups as $group)
                        <div class="thread-card">
                            ...
                            <div class="thread-header">
                                ...
                                <a href="{{ route('forum.group', $group->id) }}"
                                    class="thread-title-link">{{ $group->name }}</a>
                            </div>
                                ...
                                <div class="thread-author">
                                    <div class="author-info">
                                        <div class="author-avatar">
                                            <img src="{{ $group->createdBy->image ?? 'https://via.placeholder.com/50x50' }}"
                                                alt="Creator Avatar">
                                        </div>
                                    ...
                                    <div class="thread-meta">
                                        <div class="thread-stats">
                                            <div class="thread-stat">
                                                <i class="far fa-comment"></i> {{ $group->posts_count }} posts
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="thread-footer">
                                ...
                                @if ($group->latestPosts->count() > 0)
                                    <div class="last-reply">
                                        <div class="reply-avatar">
                                            <img src="{{ $group->latestPosts->first()->user->image ?? 'https://via.placeholder.com/24x24' }}"
                                                alt="User Avatar">
                                        </div>
                                        <div class="reply-info">
                                            Last post by <a
                                                href="#">{{ $group->latestPosts->first()->user->firstname }}
                                                {{ $group->latestPosts->first()->user->lastname }}</a> •
                                            {{ $group->latestPosts->first()->created_at->diffForHumans() }}
                                        </div>
                                    </div>
                                @else
                                    <div class="last-reply">
                    ...
                    @if ($groups->count() == 0)
                        <div class="thread-card">
                            <div class="thread-content">
                                <div class="thread-preview">
                                    <div class="thread-excerpt text-center py-4">
                                        No discussion groups found. Be the first to create one!
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="forum-stats">
                    ...
                    <ul class="stats-list">
                        <li class="stats-item">
                            ...
                            <div class="stats-value">{{ $stats['total_posts'] }}</div>
                        </li>
                        <li class="stats-item">
